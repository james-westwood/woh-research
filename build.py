...
ELEC_CATS = [
    ('Techno', ['techno', 'acid']),
    ('House', ['house']),
    ('Garage / Bass', ['garage', 'bass', 'grime', 'gqom', 'ukg']),
    ('D&B / Jungle', ['drum & bass', 'jungle', 'halftime']),
    ('Dub / Dubstep', ['dub', 'steppers', 'reggae']),
    ('Electro / Broken Beat', ['broken beat', 'electro', 'experimental electronic', 'electronic']),
    ('Disco / Boogie', ['disco', 'boogie']),
    ('Eclectic / Global', ['eclectic', 'global', 'afro', 'balearic', 'brazilian', 'nu-jazz', 'north african', 'dancehall']),
]

SJ_CATS = [
    ('Jazz', ['jazz', "warriors showcase", 'classical']),
    ('Soul / R&B', ['soul', 'r&b']),
    ('Hip-hop / Rap', ['hip-hop', 'rap']),
    ('Afrobeat / Global', ['global', 'brazilian', 'tanzanian', 'orchestral']),
